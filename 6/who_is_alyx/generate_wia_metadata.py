...
This dataset is part of the XR Motion Dataset Catalogue, containing motion capture data from Virtual Reality (VR) interactions. It was created for the study "Who is Alyx? A new behavioral biometric dataset for user identification in XR" by Rack et al. The dataset includes motion capture data and behavioral features gathered from users interacting with XR environments. 
...
# Example usage
data_directory = r"D:\Motion Data Project\Milestone 2\xr_motion_datasets\who_is_alyx\who_is_alyx_converted" # Replace with the path to your dataset
